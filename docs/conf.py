# -*- coding: utf-8 -*-
#
# resampy documentation build configuration file, created by
...
release = resampy_version.version
...
latex_documents = [
  ('index', 'resampy.tex', u'resampy Documentation',
...
man_pages = [
    ('index', 'resampy', u'resampy Documentation',
     [u'Brian McFee'], 1)
]
...
texinfo_documents = [
  ('index', 'resampy', u'resampy Documentation',
   u'Brian McFee', 'resampy', 'One line description of project.',
   'Miscellaneous'),
]
